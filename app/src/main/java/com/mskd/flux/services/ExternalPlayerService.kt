...
class ExternalPlayerService : Service() {
    ...
    override fun onCreate() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU) {
            registerReceiver(stopServiceBroadcastReceiver, intentFilter, RECEIVER_NOT_EXPORTED)
        } else {
            ContextCompat.registerReceiver(this, stopServiceBroadcastReceiver, intentFilter, ContextCompat.RECEIVER_NOT_EXPORTED)
        }
